...
\vspace{0.1in}
\noindent\hangindent=0.5in
\noindent\begin{CJK}{UTF8}{ipxm}
\hspace{-0.15cm}陸嘉良・佐藤礼子. (2021, May 22--23). 認知負荷が日本語学習者の発話に与える影響：口頭流暢性の客観指標に注目して [口頭発表]. 2021年度日本語教育学会春季大会, オンライン開催.
\end{CJK}
...
\hspace{0.5in}\textit{This research forms the foundation of Chapter 3.}
...
\noindent\hangindent=0.5in
\begin{CJK}{UTF8}{ipxm}
\noindent\hspace{-0.15cm}陸嘉良・佐藤礼子. (2022, August 20--30). 認知負荷の異なる課題に対する困難さと面白さの評価：クラスタリングによる変化パターンの比較 [口頭発表]. 日本教育心理学会第64回総会, オンライン開催.
\end{CJK}
