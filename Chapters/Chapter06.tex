...
This chapter integrates the production findings from Study 1 (\autoref{ch:study1}) and the listener-judgement findings from Study 2 (\autoref{ch:study2}) and interprets them within the capacity-limited framework established in \autoref{ch:intro-roadmap} and \autoref{ch:cogload}. Table~\ref{tab:recap-studies12} summarizes the key findings that inform this synthesis.
...
Study 2: 
Listener Judgments & 
Ratings of “easy to understand” and “fluent” moved together very strongly. In easier tasks, two things mainly hurt ratings: long pauses at the ends of clauses and more errors. In harder tasks, comprehensibility relied on more cues: richer clause building and appropriate case particles helped; end-clause pauses, many auxiliaries, greater lexical variety, and more dysfluencies hurt. Perceived fluency overlapped partly with these cues. A Japanese-specific pattern emerged: pauses at clause ends mattered much more than mid-clause pauses. \\
\bottomrule
\end{tabular}
\end{table}

The goal is to give a single account of how validated increases in intrinsic demand reallocate attention during L2 speech, how those reallocations surface in native listener judgments, and what the joint pattern implies for task design and assessment in L2 Japanese.
