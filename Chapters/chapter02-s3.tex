...
\caption[Cognitive cask complexity dimensions in the Triadic Componential Framework]{Cognitive cask complexity dimensions in the Triadic Componential Framework (adapted from Robinson, 2005)}
\footnotesize
