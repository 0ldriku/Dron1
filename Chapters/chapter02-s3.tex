...
\caption[Cognitive task complexity dimensions in the Triadic Componential Framework]{Cognitive task complexity dimensions in the Triadic Componential Framework (adapted from Robinson, 2005)}
\footnotesize
