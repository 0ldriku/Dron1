...
Another noteworthy finding that contrasts with prior research concerns the role of pause location in comprehensibility. While \textcite{SuzukiKormos2020} found mid-clause pausing to be a primary cue for comprehensibility in English, only final-clause pausing was a significant predictor in the current study. This reflects Japanese's SOV structure (see \autoref{subsec:comp-sigs}), where clause-final pausing delays access to critical morphological and semantic information, forcing listeners to hold incomplete propositions in working memory.
