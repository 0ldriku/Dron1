%************************************************
\chapter{Study 2: Linguistic Correlates of Speech Perception}\label{ch:study2}
%************************************************
...
\subsection{RQ3: Linguistic Dimensions of Perceived Fluency}
...
Another noteworthy finding that contrasts with prior research concerns the role of pause location in comprehensibility. While \textcite{SuzukiKormos2020} found mid-clause pausing to be a primary cue for comprehensibility in English, only final-clause pausing was a significant predictor in the current study. This reflects Japanese's Subject-Object-Verb (SOV)\footnote{A term for the basic grammatical structure of a language, like Japanese or Korean, where the verb typically comes last (e.g., ``She the ball hit''). This contrasts with English, which is SVO (Subject-Verb-Object) (e.g., ``She hit the ball'').} structure, where clause-final pausing delays access to critical morphological and semantic information, forcing listeners to hold incomplete propositions in working memory.
