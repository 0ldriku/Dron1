%************************************************
\chapter{Study 2: Listener Judgements Under Load}\label{ch:study2}
%************************************************

\section{Introduction}

The previous study established that L2 speakers' production profiles are systematically reshaped by cognitive load. Effective communication is a collaborative process that also depends on the listener's capacity to process and interpret the resulting message\parencite{baeseberk2020}. This leads to the central question for the present study: What are the perceptual consequences of these production trade-offs? This study investigates precisely that question. Using the same speech samples produced under validated load conditions in Study 1, we examine how the specific, load-induced shifts in speakers' production influence native listeners' judgments. To do this, we focus on two essential components for successful L2 communication: comprehensibility and perceived fluency.

Comprehensibility, the listener's perception of how easily they understand L2 speech \parencite{MunroDerwing1999}, is crucial for communicative success in real-world interactions \parencite{DerwingMunro2009} and is assessed in high-stakes language tests such as the International English Language Testing System (IELTS) and the Test of English as a Foreign Language (TOEFL) \parencite{IsaacsTrofimovich2012}. Alongside comprehensibility, fluency is also considered an essential component for successful L2 communication \parencite{suzuki2021}. \textcite{lennon1990,lennon2000} distinguished two senses of fluency: fluency in the broad sense (overall oral proficiency) and fluency in the narrow sense (smoothness of speech). Besides this distinction, \textcite{Segalowitz2010} proposed a framework to better integrate various facets of fluency such as listener-based judgements of fluency and temporal features of speech. He distinguished among utterance fluency (observable temporal features), cognitive fluency (underlying psycholinguistic processes), and perceived fluency (listeners' inferences about cognitive fluency based on utterance fluency features).
...
Previous research on the linguistic dimensions of listener judgments, such as comprehensibility, intelligibility (the actual degree of listener understanding; \citeauthor{MunroDerwing1999}, \citeyear{MunroDerwing1999}), and accentedness (the perceived influence of the speaker's native or nonnative features on L2 speech; \citeauthor{DerwingMunro2015}, \citeyear{DerwingMunro2015}) has focused mainly on English \parencite[e.g.,][]{crowther2018,saito2016a}. Although recent studies have begun exploring languages such as French \parencite{Bergeron2017}, Spanish \parencite{huensch2021}, and Japanese \parencite{saito2017}, it is unclear how readily findings from English transfer to typologically distinct languages like Japanese.
...
The study faces several limitations. First, the rater sample consisted of eight highly experienced university-level Japanese instructors, which likely increased rating consistency, but it also limits generalizability to less experienced or mixed-L1 raters. Second, although we modeled many linguistic predictors, we did not include segmental or prosodic phonetic measures, so we cannot rule out the possibility that listeners also relied on those cues.
